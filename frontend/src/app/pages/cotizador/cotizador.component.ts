...
export class CotizadorComponent implements OnInit {
  ...
  private precioKoi3D(ancho_cm: number, alto_cm: number, material: number, impresion: number): number {
    ...
    const layouts = [
        ...
        { w: 100, h: 50, m: 2.190 }, // ~180.000
        { w: 50, h: 100, m: 2.190 }, // ~180.000 (redundancia por área, misma área que 100x50)
        { w: 100, h: 100, m: 1.582 } // ~260.000
    ];
  ...
  private precioKoiFraccionado(ancho_cm: number, alto_cm: number, costo_m2: number): number {
    ...
    // 50x100 = 110.000 => 110000 / (53180 * 0.5) = 4.13689
    // 120x60 = 140.000 => 140000 / (53180 * 0.72) = 3.6565
    // 150x80 = 190.000 => 190000 / (53180 * 1.2) = 2.9774
    // 200x100 = 260.000 => 260000 / (53180 * 2) = 2.4445
    const layouts = [
        { w: 100, h: 50, m: 4.137 },  
        { w: 50, h: 100, m: 4.137 },
        { w: 120, h: 60, m: 3.657 },  
